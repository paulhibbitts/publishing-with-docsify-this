...
### What is Markdown? 
[Markdown](https://en.wikipedia.org/wiki/Markdown) is a syntax to format the display of content stored as plain text - similar but simpler than HTML formatting
